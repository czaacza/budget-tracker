...
function Form({ userId }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    addIncome({ ...inputState, userId }, userId);
    setInputState({
      title: '',
      amount: '',
      date: '',
    ...
    <FormStyled onSubmit={handleSubmit}>
      ...
      <div className="selects input-control">
        ...
        >
          ...
          <option value="freelancing">{t('freelancing')}</option>
